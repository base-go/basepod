...
var Templates = []Template{
	...
	},
	{
		...
		Volumes: []VolumeConfig{
			{Name: "data", ContainerPath: "/var/lib/postgresql"},
		},
		Category: "database",
		Icon:     "i-lucide-database",
	},
	...
	// CMS / Apps
	{
		...
		Image:          "wordpress",
		Versions:       []string{"6.7", "6.6", "php8.3", "latest"},
		DefaultVersion: "6.7",
	...
	},
	{
		...
		Versions: []string{"2.21", "2.20", "latest"},
		DefaultVersion: "2.21",
		Port:     9000,
		Env:      map[string]string{},
		Category: "devtools",
	...
	},
	{
		...
		Versions:    []string{"release", "latest"},
		DefaultVersion: "release",
		Port:        2283,
		Env: map[string]string{
			"DB_HOSTNAME":    "basepod-postgres",
			"DB_USERNAME":    "basepod",
			"DB_PASSWORD":    "changeme",
			"DB_DATABASE_NAME": "immich",
			"REDIS_HOSTNAME": "basepod-redis",
		},
		Volumes: []VolumeConfig{
			{Name: "upload", ContainerPath: "/usr/src/app/upload"},
		},
		Category: "media",
		Icon:     "i-lucide-image",
	},
	...
	// Proxy
	{
		...
		Image:       "traefik",
		Versions:    []string{"v3.2", "v3.1", "v2.11", "latest"},
		DefaultVersion: "v3.2",
		Port:        8080,
		Env:         map[string]string{},
